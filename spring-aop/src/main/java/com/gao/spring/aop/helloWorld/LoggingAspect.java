...
public class LoggingAspect {
	 ...
	 */
	@Pointcut("execution(public int com.gao.spring.aop.helloWorld.ArithmeticCalculator.*(..))")
	public void declareJointPointExpression(){}

	//在 com.atguigu.spring.aop.ArithmeticCalculator 接口的每一个实现类的每一个方法开始之前执行一段代码
//	@Before("execution(public int com.gao.spring.aop.helloWorld.ArithmeticCalculator.*(int, int))")
...
//	@After("execution(* com.gao.spring.aop.*.*(..))")
	...
	/*
	 ...
	 将throwing属性添加到@AfterThrowing注解中,也可以访问连接点抛出的异常. Throwable 是所有错误和异常类的超类.所以在异常通知方法可以捕获到任何错误和异常.
